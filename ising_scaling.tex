...
series are fit, the truncations of $F$ and $h$ are extended to higher order so
that the codimension of the fit is constant. A term is added to $F$ whenever a
new coefficient of the high temperature series is added, and one is added to
$h$ whenever a new coefficient of the low temperature series is added.
